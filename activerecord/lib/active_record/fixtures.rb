        ...
        connection.disable_referential_integrity do
          ...
          connection.transaction(:requires_new => true) do
            fixture_sets.each do |fs|
              ...
              ff.table_rows.each_key do |table_name|
      ...
      rows[table_name] = fixtures.map do |label, fixture|
        ...
        if model_class
          ...
          row.each do |key, value|
            row[key] = value.gsub("$LABEL", label.to_s) if value == "$LABEL"
          end
...
module ActiveRecord
  module TestFixtures
    ...
    def create_fixtures_from_yaml
      fixtures = FixtureSet.create_fixtures(fixture_path, fixture_table_names, fixture_class_names)
    ...
    def load_fixtures
      FixtureSet::FIXTURE_REALMS.each do |fixture_name|
